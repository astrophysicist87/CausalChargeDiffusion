...
namespace SFL
{
	...
	int ccubic(struct complex *a1, struct complex *a2, struct complex *a3, struct complex *r1, struct complex *r2, struct complex *r3)
	{
	...
	int cquartic(struct complex *a1, struct complex *a2, struct complex *a3, struct complex *a4, struct complex *r1, struct complex *r2, struct complex *r3, struct complex *r4)
	{
	struct complex a,b,c,d,q1,q2,q3,m,q,g,h,b1,b2,b3,b4;
	int try_loc,sel;double bestr;
	CTREAL(a,*a2,-.5);
	...
	try_loc=ccubic(&a,&b,&c,&q1,&q2,&q3);
	if(try_loc){fprintf(stderr," cquartic bad return ccubic\n");return 1;}
	/*
	printf(" q1 %le %le\n",q1.x,q1.y);
	printf(" q2 %le %le\n",q2.x,q2.y);
	printf(" q3 %le %le\n",q3.x,q3.y);
	 */
	try_loc=sel=0;bestr=1.e30;
	CLET(q,q1);
	...
	int quartic(double a, double b, double c, double d, struct complex *r1, struct complex *r2, struct complex *r3, struct complex *r4)
	{
