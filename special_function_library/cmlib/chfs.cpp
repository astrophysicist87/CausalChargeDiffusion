...
namespace SFL
{
	...
	{
		struct complex a,b,c,d,x,c1,c2,a1,a2,one;
		int oldrot;
		CMPLX(a,0., pi/6.);
		CMPLX(b,0., 2.*pi/3.);
		CMPLX(one,1.,0.);
	...
	int bateman(struct complex *nu, struct complex *x, struct complex *ans)
	{
		struct complex a,b,c,d;
	...
	int cunningham(struct complex *n, struct complex *m, struct complex *x, struct complex *ans)
	{
	...
	int toronto(struct complex *m, struct complex *n, struct complex *r, struct complex *ans)
	{
