...
namespace SFL
{
	...
	int forward(struct complex *z, struct complex *ratio, int idim, struct complex *r1)
	{
	...
	int backward(struct complex *z, struct complex *ratio, int idim)
	{
	...
	int bessel(int nn, struct complex *z, struct complex *j, struct complex *y,
			struct complex *h2, struct complex *jprime, struct complex *yprime,
			struct complex *h2prime, int *ivalck)
	{
	...
	int cbess(struct complex *z, struct complex *j0, struct complex *j1,
			struct complex *y0, struct complex *y1, struct complex *h20, struct complex *h21,
			int *ivchk)
	{
