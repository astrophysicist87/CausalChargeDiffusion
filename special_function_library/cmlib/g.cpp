...
namespace SFL
{
	...
	*/
	...
	int i,itmax=100;
	double gln,sum,ap,del,fi,start,
	...
	double lcgam(double a, double x)
	{return P(a,x)*gamma(a);}

	double ucgam(double a, double x)
	{return gamma(a)*(1.-P(a,x));}

	double BigGamma(double a, double x)
	{/* incomplete gamma function*/
	int i,itmax=100;
	double mult,offset,sum,ap,del,fi,start,
